...
describe("Image API Endpoints", () => {
    // Increase timeout for file ops
    jasmine.DEFAULT_TIMEOUT_INTERVAL = 10000;
    const testImagePath = path_1.default.join(__dirname, "testfiles/test.jpg");
    it("should upload an image", async () => {
        const res = await (0, supertest_1.default)(app_1.default)
            .post("/api/upload")
            .attach("image", path_1.default.join(__dirname, "testfiles/test.jpg"));
